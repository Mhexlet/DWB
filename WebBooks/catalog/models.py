...
class Book(models.Model):
    ...
    genre = models.ForeignKey('Genre', on_delete=models.CASCADE, help_text="Выберите жанр для книги", null=True)
...
class BookInstance(models.Model):
    ...
    inv_nom = models.CharField(max_length=20, null=True, help_text="Введите инвентарный номер экземпляра", verbose_name="Инвентраный номер")
